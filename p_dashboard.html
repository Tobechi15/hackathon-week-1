...
<body>
  ...
  <!-- <header class="fixed top-0 z-30 w-full bg-white/80 backdrop-blur-sm transition-all duration-300 dark:bg-gray-black">
    <div class="container mx-auto px-4 py-4 xl:px-16 flex justify-between items-center">
        ...
        <a href="signup.html" class="hidden md:block bg-blue-600 text-white px-4 py-2 rounded">Get Started</a>
        <div class="md:hidden">
    ...
    <div id="mobile-menu" class="hidden md:hidden p">
        <a href="index.html" class="block py-2 px-4 text-gray-700 hover:bg-gray-200">Home</a>
  ...
  <!-- <div class="container">
    <div class="form-container">
      <form class="form signup-form">
        ...
        <input class="w-full mt-2 bg-blue-600 text-white px-6 py-2 rounded inline-block" type="submit" onclick="navigateTo()" value="Signup">
        <button type="submit" onclick="navigateTo()">Signup</button>
